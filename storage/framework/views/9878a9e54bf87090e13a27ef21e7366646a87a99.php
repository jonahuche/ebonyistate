  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="<?php echo e(asset('images/banner1.jpg')); ?>" alt="Projects" width="100%" height="345">
      ...
      <div class="item">
        <img src="<?php echo e(asset('images/akanuibiamflyover.jpg')); ?>" alt="Akanu Ibiam Flyover" width="100%" >
        <div class="carousel-caption">
          <h3>Ebonyi</h3>
      ...
      <div class="item">
        <img src="<?php echo e(asset('images/goodroadnetwork.jpg')); ?>" alt="Flower" width="100%">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="<?php echo e(asset('images/roundabout.jpg')); ?>" alt="Ebonyi State Shoe Room" width="100%">
        <div class="carousel-caption">
          <h3>Show Room</h3>
